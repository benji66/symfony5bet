...
class CorreccionController extends AbstractController
{
    ...
    public function delete(Request $request, Correccion $correccion): Response
    {
     ...
     /**
     * @Route("/pdf", name="correccion_pdf", methods={"GET"})
     */
     public function getPdf(CorreccionRepository $correccionRepository, Request $request)
     {        // Configure Dompdf according to your needs
        ...
        $html = $this->renderView('correccion/pdf.html.twig', [
            'correccions' => $allRowsQuery
        ]);
