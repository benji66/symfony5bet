...
class ApuestaPropuestaController extends AbstractController
{
    ...
    public function delete(Request $request, ApuestaPropuesta $apuestaPropuestum): Response
    {
     ...
     /**
     * @Route("/pdf", name="apuesta_propuesta_pdf", methods={"GET"})
     */
     public function getPdf(ApuestaPropuestaRepository $apuestaPropuestaRepository, Request $request)
     {        // Configure Dompdf according to your needs
        ...
        $html = $this->renderView('apuesta_propuesta/pdf.html.twig', [
            'apuesta_propuestas' => $allRowsQuery
        ]);
